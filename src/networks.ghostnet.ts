...
export const ithacanetTokens: Record<string, Token> = {
  ...
  cchfToken: { ...cchfToken, contractAddress: 'KT1HXqAifZMRAn4TzwK6gUQxYZHTSiVu58cF', tokenId: 0 },
  ...
  ctezcchfLP: { ...ctezcchfLP, decimals: 6, contractAddress: 'KT1HXqAifZMRAn4TzwK6gUQxYZHTSiVu58cF', tokenId: 1 },
...
export const ithacanetDexes: ExchangePair[] = [
  {
    ...
    contractAddress: 'KT1HXqAifZMRAn4TzwK6gUQxYZHTSiVu58cF',
    ...
    collateralOptions: [
      {
        ...
        ENGINE_ADDRESS: 'KT1HXqAifZMRAn4TzwK6gUQxYZHTSiVu58cF',
